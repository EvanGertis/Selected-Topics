	...
	<center>
		<div id='boxstyle'>
			<h3 id='title'>title</h3>
				<center>
					<div class='source'>
						<div id='s0' class='draggyBox-small ui-draggable'>
							keyOne
						</div>
					...
					<table id='tablestyle'>
						<tr>
						<td id='row0'>
							<div id='t0' class='ltarget ui-droppable'></div>
						</td >
						<td id='d0'>
							desOne
							</td >
