	...
	<center>
		<div id='boxstyle'>
			<h3 id='title'>Title</h3>
				<center>
					<div class='source'>
						<div id='s[object HTMLInputElement]' class='draggyBox-small ui-draggable'>
							keyTwo
						</div>
					...
					<table id='tablestyle'>
						<tr>
						<td id='rowundefined'>
							<div id='tundefined' class='ltarget ui-droppable'></div>
						</td >
						<td id='dundefined'>
							desTwo
							</td >
