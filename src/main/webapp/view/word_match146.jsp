			...
			<h3 id='title'>Terraform Quiz</h3>
				<center>
					...
					<table id='tablestyle'>
						...
						<td id='d1'>
							defines where and how operations are performed, where state snapshots are stored
							</td >
						</tr>
						<tr>
						<td id='row2'>
